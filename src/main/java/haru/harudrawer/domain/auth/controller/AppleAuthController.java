...
public class AppleAuthController {
    ...
    public AppleAuthController(@Qualifier("appleAuthService") SocialAuthService socialAuthService) {
    ...
    public ResponseEntity<ApiResponse<CommonResponseDTO.LoginResponseDTO>> login(@RequestParam String authorizationCode) throws Exception {
        CommonResponseDTO.LoginResponseDTO result = socialAuthService.login(authorizationCode);
